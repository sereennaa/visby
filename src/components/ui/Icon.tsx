...
export const iconMap = {
  ...
  history: { family: 'MaterialCommunityIcons', name: 'script-text' },
  ...
  flashcard: { family: 'MaterialCommunityIcons', name: 'card-multiple-outline' },
  cards: { family: 'MaterialCommunityIcons', name: 'card-multiple-outline' },
  ...
  copy: { family: 'Ionicons', name: 'copy' },
  ...
  seedling: { family: 'MaterialCommunityIcons', name: 'sprout' },
  palette: { family: 'MaterialCommunityIcons', name: 'palette' },
  ...
  cat: { family: 'MaterialCommunityIcons', name: 'cat' },
  whale: { family: 'MaterialCommunityIcons', name: 'whale' },
  octopus: { family: 'MaterialCommunityIcons', name: 'octagram' },
  sailboat: { family: 'Ionicons', name: 'boat' },
  happy: { family: 'Ionicons', name: 'happy' },
  sad: { family: 'Ionicons', name: 'sad' },
  plant: { family: 'MaterialCommunityIcons', name: 'flower' },
  sun: { family: 'Ionicons', name: 'sunny' },
  torii: { family: 'MaterialCommunityIcons', name: 'torii-gate' },
  pyramid: { family: 'MaterialCommunityIcons', name: 'pyramid' },
  mosque: { family: 'MaterialCommunityIcons', name: 'mosque' },
  kangaroo: { family: 'MaterialCommunityIcons', name: 'kangaroo' },
  lion: { family: 'MaterialCommunityIcons', name: 'paw' },
