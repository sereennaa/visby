...
export const COUNTRIES: Country[] = [
  ...
  },
  {
    ...
    accentColor: '#FECDD3',
    facts: [
      { id: 'br1', countryId: 'br', title: 'Ola!', content: '"Ola" means "hello" in Portuguese. Brazil is the biggest country in South America!', icon: 'language', category: 'language', imageUrl: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=600' },
      { id: 'br2', countryId: 'br', title: 'The Amazon', content: 'The Amazon rainforest is in Brazil. It has more types of plants and animals than almost anywhere on Earth!', icon: 'nature', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1516306580123-e6e52b1b7b5f?w=600' },
      { id: 'br3', countryId: 'br', title: 'Carnival', content: 'Carnival is a huge party with music, dancing, and colorful costumes. It happens every year!', icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1551649001-7a2482d98d05?w=600' },
      { id: 'br4', countryId: 'br', title: 'Yummy fruits', content: 'Brazil has amazing fruits like acai, passion fruit, and guava. Try acai bowls -- they\'re like a smoothie!', icon: 'food', category: 'food', imageUrl: 'https://images.unsplash.com/photo-1590301157890-4810ed352733?w=600' },
      { id: 'br5', countryId: 'br', title: 'Soccer passion', content: 'Brazilians love soccer (they call it "futebol"). Brazil has won the World Cup more than any other country!', icon: 'sparkles', category: 'fun', imageUrl: 'https://images.unsplash.com/photo-1518639192441-8fce0a366e2e?w=600' },
    ],
  },
  {
    id: 'kr',
    ...
    accentColor: '#A8C8FF',
    facts: [
      { id: 'kr1', countryId: 'kr', title: 'K-pop fever', content: 'K-pop groups like BTS and BLACKPINK have millions of fans worldwide. Music videos are famous for their amazing choreography and colorful sets!', icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1583167616706-59fca7c3ae12?w=600' },
      { id: 'kr2', countryId: 'kr', title: 'Kimchi with everything', content: 'Koreans eat kimchi (fermented spicy cabbage) with almost every meal. There are over 200 types of kimchi!', icon: 'food', category: 'food', imageUrl: 'https://images.unsplash.com/photo-1607301405390-d831c242f59b?w=600' },
      { id: 'kr3', countryId: 'kr', title: 'Tech capital', content: 'South Korea is one of the most connected countries on Earth. It has super-fast internet and is home to Samsung and LG!', icon: 'sparkles', category: 'fun', imageUrl: 'https://images.unsplash.com/photo-1546874177-9e664f59e1a4?w=600' },
      { id: 'kr4', countryId: 'kr', title: 'Hanbok tradition', content: 'The hanbok is a traditional Korean dress with a wrap-around top and wide skirt. People wear them during holidays like Chuseok and Seollal!', icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1517154421773-0529f29ea451?w=600' },
      { id: 'kr5', countryId: 'kr', title: 'Say annyeong!', content: '"Annyeonghaseyo" means "hello" in Korean. Try saying it: ahn-nyeong-ha-se-yo!', icon: 'language', category: 'language', imageUrl: 'https://images.unsplash.com/photo-1553163147-622ab57be1c7?w=600' },
    ],
  },
  {
    id: 'th',
    ...
    accentColor: '#FFD700',
    facts: [
      { id: 'th1', countryId: 'th', title: 'Temple treasures', content: 'Thailand has over 40,000 Buddhist temples! The most famous, Wat Phra Kaew, holds a tiny jade Buddha statue that is very sacred.', icon: 'temple', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1528181304800-259b08848526?w=600' },
      { id: 'th2', countryId: 'th', title: 'Pad Thai perfection', content: 'Pad Thai is a stir-fried noodle dish with peanuts, lime, and bean sprouts. Street food vendors make it fresh in giant woks!', icon: 'food', category: 'food', imageUrl: 'https://images.unsplash.com/photo-1559314809-0d155014e29e?w=600' },
      { id: 'th3', countryId: 'th', title: 'Songkran splash', content: 'Songkran is the Thai New Year water festival. For three days, everyone has massive water fights in the streets!', icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=600' },
      { id: 'th4', countryId: 'th', title: 'Gentle giants', content: 'Elephants are the national animal of Thailand. They are deeply respected and there are sanctuaries where rescued elephants live happily.', icon: 'nature', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1549366021-9f761d450615?w=600' },
      { id: 'th5', countryId: 'th', title: 'Muay Thai', content: 'Muay Thai (Thai boxing) is called the "Art of Eight Limbs" because fighters use fists, elbows, knees, and shins. It has been practiced for centuries!', icon: 'star', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1504214208698-ea1916a2195a?w=600' },
    ],
  },
  {
    id: 'ma',
    ...
    accentColor: '#E07848',
    facts: [
      { id: 'ma1', countryId: 'ma', title: 'Magical medinas', content: 'Moroccan medinas are old walled cities with winding streets full of shops selling spices, leather goods, and pottery. Marrakech has the most famous one!', icon: 'landmark', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1539650116574-8efeb43e2750?w=600' },
      { id: 'ma2', countryId: 'ma', title: 'Beautiful tiles', content: 'Moroccan buildings are decorated with zellige — tiny hand-cut tiles arranged in stunning geometric patterns. Craftspeople train for years to master this art!', icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1558370781-d6196949e317?w=600' },
      { id: 'ma3', countryId: 'ma', title: 'Sahara adventure', content: 'The Sahara Desert covers part of southern Morocco. You can ride camels over golden sand dunes and sleep under millions of stars!', icon: 'nature', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=600' },
      { id: 'ma4', countryId: 'ma', title: 'Mint tea ritual', content: 'Moroccan mint tea is poured from high up to create a frothy top. It is served three times — the first glass is gentle, the second strong, and the third sweet.', icon: 'cafe', category: 'food', imageUrl: 'https://images.unsplash.com/photo-1571934811356-5cc061b6821f?w=600' },
      { id: 'ma5', countryId: 'ma', title: 'Carpet weaving', content: 'Berber carpets are handwoven by women in the Atlas Mountains. Each pattern tells a story, and a single carpet can take months to complete!', icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1541518763669-27fef04b14ea?w=600' },
    ],
  },
  {
    id: 'pe',
    ...
    accentColor: '#D4A574',
    facts: [
      { id: 'pe1', countryId: 'pe', title: 'Machu Picchu', content: 'Machu Picchu is an ancient Inca city perched high in the Andes Mountains. It was hidden from the world for hundreds of years until 1911!', icon: 'landmark', category: 'history', imageUrl: 'https://images.unsplash.com/photo-1526392060635-9d6019884377?w=600' },
      { id: 'pe2', countryId: 'pe', title: 'Inca ingenuity', content: 'The Inca Empire built roads, bridges, and cities without using wheels or iron tools. They kept records using knotted strings called quipus!', icon: 'history', category: 'history', imageUrl: 'https://images.unsplash.com/photo-1526958097901-5e6d742d3371?w=600' },
      { id: 'pe3', countryId: 'pe', title: 'Ceviche delight', content: "Ceviche is Peru's national dish — fresh raw fish 'cooked' in lime juice with onions and chili peppers. It has been made for thousands of years!", icon: 'food', category: 'food', imageUrl: 'https://images.unsplash.com/photo-1535399831218-d5bd36d1a6b3?w=600' },
      { id: 'pe4', countryId: 'pe', title: 'Amazon and Andes', content: 'Peru has it all: the Andes Mountains, the Amazon Rainforest, and a desert coast. It is one of the most biodiverse countries on Earth!', icon: 'mountain', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1580619305218-8423a7ef79b4?w=600' },
      { id: 'pe5', countryId: 'pe', title: 'Colorful textiles', content: 'Peruvian weavers use techniques passed down for thousands of years. Alpaca wool is softer than sheep wool, and each pattern represents a village or family!', icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1531968455002-901e9197d212?w=600' },
    ],
  },
  {
    id: 'ke',
    ...
    accentColor: '#C8846E',
    facts: [
      { id: 'ke1', countryId: 'ke', title: 'Safari wonderland', content: "Kenya's Maasai Mara reserve is home to the Great Migration, where over a million wildebeest cross the plains. Lions, elephants, and giraffes roam freely!", icon: 'nature', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=600' },
      { id: 'ke2', countryId: 'ke', title: 'Maasai culture', content: 'The Maasai people are famous for their red clothing, beaded jewelry, and incredible jumping dances. They have lived alongside wildlife for centuries!', icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=600' },
      { id: 'ke3', countryId: 'ke', title: 'Great Rift Valley', content: "The Great Rift Valley runs through Kenya and is so big it can be seen from space! It was formed millions of years ago as the Earth's plates pulled apart.", icon: 'mountain', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1541252260730-0412e8e2108e?w=600' },
      { id: 'ke4', countryId: 'ke', title: 'Kenyan coffee', content: "Kenya grows some of the world's best coffee beans on the slopes of Mount Kenya. Coffee is one of the country's most important crops!", icon: 'cafe', category: 'food', imageUrl: 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=600' },
      { id: 'ke5', countryId: 'ke', title: 'Running champions', content: 'Kenyan runners are the fastest long-distance athletes in the world! Many champions come from the highlands, where training at high altitude builds incredible endurance.', icon: 'star', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1604329760661-e71dc83f8f26?w=600' },
    ],
  },
  {
    id: 'no',
    ...
    accentColor: '#87CEEB',
    facts: [
      { id: 'no1', countryId: 'no', title: 'Fabulous fjords', content: "Norway's fjords are long, narrow inlets carved by glaciers thousands of years ago. They have steep cliffs and crystal-clear water — some are over 1,000 meters deep!", icon: 'mountain', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1507272931001-fc06c17e4f43?w=600' },
      { id: 'no2', countryId: 'no', title: 'Viking voyagers', content: 'Vikings sailed from Norway over 1,000 years ago in longships. They explored Iceland, Greenland, and even reached North America before Columbus!', icon: 'history', category: 'history', imageUrl: 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=600' },
      { id: 'no3', countryId: 'no', title: 'Northern lights', content: "The aurora borealis lights up Norway's sky with green, purple, and pink ribbons of light. It happens when particles from the sun hit Earth's atmosphere!", icon: 'sparkles', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1483347756197-71ef80e95f73?w=600' },
      { id: 'no4', countryId: 'no', title: 'Troll tales', content: 'Norwegian folklore is full of trolls — big creatures that live in mountains and turn to stone in sunlight. You can see troll statues all over Norway!', icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1513622470522-26c3c8a854bc?w=600' },
      { id: 'no5', countryId: 'no', title: 'Friluftsliv', content: '"Friluftsliv" means "open-air living" in Norwegian. Norwegians love hiking, skiing, and being outdoors all year — even in snowy winters!', icon: 'nature', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600' },
    ],
  },
  {
    id: 'tr',
    ...
    accentColor: '#E8A87C',
    facts: [
      { id: 'tr1', countryId: 'tr', title: 'Grand Bazaar', content: "Istanbul's Grand Bazaar is one of the oldest and largest covered markets in the world. It has over 4,000 shops selling everything from spices to lanterns!", icon: 'landmark', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1541432901042-2d8bd64b4a9b?w=600' },
      { id: 'tr2', countryId: 'tr', title: 'Cappadocia balloons', content: "Every morning, hundreds of hot air balloons float over Cappadocia's fairy chimneys — tall, thin rock formations shaped by wind and rain over millions of years!", icon: 'sparkles', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1641128324972-af3212f0f6bd?w=600' },
      { id: 'tr3', countryId: 'tr', title: 'Turkish delights', content: 'Turkish delight (lokum) is a chewy, sweet candy dusted with powdered sugar. It has been made since the 1700s and comes in flavors like rose, lemon, and pistachio!', icon: 'food', category: 'food', imageUrl: 'https://images.unsplash.com/photo-1576618148400-f54bed99fcfd?w=600' },
      { id: 'tr4', countryId: 'tr', title: 'Hammam tradition', content: "Turkish hammams (bathhouses) have been a tradition for over 600 years. People go to steam, scrub, and relax — it's like a spa for the whole community!", icon: 'culture', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1540555700478-4be289fbec6e?w=600' },
      { id: 'tr5', countryId: 'tr', title: 'Two continents', content: 'Istanbul is the only major city in the world that sits on two continents — Europe and Asia! The Bosphorus strait divides the two sides.', icon: 'landmark', category: 'history', imageUrl: 'https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?w=600' },
    ],
  },
  {
    id: 'gr',
    ...
    accentColor: '#6EA8D7',
    facts: [
      { id: 'gr1', countryId: 'gr', title: 'Mythical gods', content: 'Ancient Greeks believed gods like Zeus, Athena, and Poseidon lived on Mount Olympus. Their stories of heroes and monsters are still told today!', icon: 'history', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1555993539-1732b0258235?w=600' },
      { id: 'gr2', countryId: 'gr', title: 'Island paradise', content: 'Greece has about 6,000 islands, but only 227 are inhabited! Santorini is famous for its white buildings with blue domes overlooking the sparkling sea.', icon: 'nature', category: 'nature', imageUrl: 'https://images.unsplash.com/photo-1533105079780-92b9be482077?w=600' },
      { id: 'gr3', countryId: 'gr', title: 'Greek food', content: 'Greeks love fresh food — olive oil, feta cheese, fresh fish, and honey drizzled on thick yogurt. The Mediterranean diet is one of the healthiest in the world!', icon: 'food', category: 'food', imageUrl: 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=600' },
      { id: 'gr4', countryId: 'gr', title: 'Olympic beginnings', content: 'The ancient Olympics started in Greece in 776 BC! Athletes competed in running, wrestling, and chariot racing. Winners received olive wreaths, not gold medals.', icon: 'star', category: 'history', imageUrl: 'https://images.unsplash.com/photo-1560703650-ef3e0f254ae0?w=600' },
      { id: 'gr5', countryId: 'gr', title: 'Love of wisdom', content: 'The word "philosophy" comes from Greek and means "love of wisdom." Great thinkers like Socrates, Plato, and Aristotle changed how the world thinks!', icon: 'book', category: 'culture', imageUrl: 'https://images.unsplash.com/photo-1530841377377-3ff06c0ca713?w=600' },
    ],
  },
